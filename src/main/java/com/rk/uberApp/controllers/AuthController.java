...
public class AuthController {
    ...
    public ResponseEntity<DriverDto> onBoardNewDriver(@PathVariable Long userId,
        ...
        return new ResponseEntity<>(authService.onBoardNewDriver(userId, vehicleDto), HttpStatus.CREATED);
    }
    ...
    public ResponseEntity<LoginResponseDto> login(@RequestBody LoginRequestDto loginRequestDto,
        ...
        return ResponseEntity.ok(new LoginResponseDto(tokens[0]));//access token is at [0]
    }
